...
- CLAUDE.md → o arquivo de instruções equivalente (por exemplo, GEMINI.md no Gemini CLI, AGENTS.md no Codex).
...
- .mcp.json e os servidores MCP (Postgres, context7) → a configuração de MCP da ferramenta escolhida.
...
- Gerar specs de teste — skill plan-test-specs — artefato specs de teste
